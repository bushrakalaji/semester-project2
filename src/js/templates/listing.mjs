  ...
  try {
    ...
    function myPosts() {
      resultById.innerHTML += `
        ...
        <div
          class="bg-primary text-light mt-5 d-flex justify-content-between align-items-start gap-3 p-5 flex-wrap"
        >
          <div class="mb-3 pt-5">
    ...
    <div class="row container gap-3 mt-5">
      ...
      <div class="bg-primary text-light col-sm-5">
        ...
        <div class="mt-5">
          <h5>Bid</h5>
          <form class="text-dark" id="bidForm">
